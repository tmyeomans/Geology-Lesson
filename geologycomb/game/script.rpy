...
# title card
    ...
    c "Welcome to today's geoadventure!  On the next screen you will have some options.\n
    \n
...
label lesson:
    ...
    a "{cps=35}we will explore and learn about what geology is.{/cps}"
    ...
    a "{cps=35}There are a lot of unknowns about the Earth yet to be discovered,{/cps}"
...
# what is a geologists/geoscientists? What do they study?
    ...
    show paleo
    show ame_teach at left
    a "{cps=35}Some geologists study fossils and learn about dinosaurs and other extinct species that used to roam our world millions of years ago.{/cps}"
    ...
    show quake
    show ame_teach at left
    a "{cps=35}Other geologists study earthquakes and use physics to learn how they behave.{/cps}"

    scene bg plain
    show oil
    show ame_teach at left

    a "{cps=35}Geologists can also explore for oil, gas and geothermal energy that provides us with energy for our homes and transportation.{/cps}"
    scene bg plain
    show ame_blink:
        xalign 0.5
        yalign 0.5
    ...
    show qtz_1:
        xalign 0.5
        yalign 0.5
    a "{cps=35}and the work that geologists do increases our quality of life.{/cps}"
...
# layers of the earth
    ...
    a "{cps=35}The mantle underneath the crust consists of melted rocks and is the source of magma which is the substance that erupts from volcanoes.{/cps}"
    ...
    show tle 5:
        ...
        xalign 0.5
        yalign 0
    a "{cps=35}The yolk is the core of the Earth.{/cps}"
...
#Igneous Rocks
    ...
    a "{cps=35}If you guessed volcanoes could be a way for magma to cool quickly, you'd be right!{/cps}"
    ...
    a "{cps=35}If you move to the shade, it’s still pretty hot but cooler than in the sun. You will start to cool off slowly.{/cps}"
    a "{cps=35}You will cool much more slowly than if you jumped in a cold pool or a lake.{/cps}"
    ...
    a "{cps=35}The magma that made up this rock left the subsurface really fast through a volcano.{/cps}"
    ...
    menu:
        "It's activity time!  Do you have an adult to help you?  And do you have sugar, string and jars at home?\n
...
label crystal_activity:
    ...
    b "{b} We have adapted the instructions from {a=https://www.thespruceeats.com/rock-candy-521016}The Spruce Eats {/a}{/b}"
...
#Sedimentary Rocks
    ...
    a "{cps=35}Those pieces may start off as huge boulders, but those are also worn down.{/cps}"
    a "{cps=35}They can eventually become tiny pieces of sand or mud.{/cps}"
    a "{cps=35}These tiny pieces of rocks can be called by many different names.  We call them grains, clasts or sediment.{/cps}"
    ...
    a "{cps=35}If you forget about them for many months they can start to stick together, with each candy acting like an individual grain.{/cps}"
    ...
    a "{cps=35}These are called siltstones or shales.  Siltstones you can barely see individual grains.  Shales you can't see grains at all.{/cps}"
    a "{cps=35}This is an example of a siltstone.{/cps}"
    ...
    a "{cps=35}This picture shows you an example of these layers.{/cps}"
    ...
    menu:
        "It's activity time!  Do you have an adult to help you?  And do you have an empty plastic bottle with a lid?\n
        If so, you can choose to do the activity now.  If not come back later."
...
label carbonates:
    ...
    a "{cps=35}Sometimes you can't see fossils because they are broken up into small pieces like the grains in clastic rocks.{/cps}"
    ...
    a "{cps=35}The circle shapes you see in the rock are ancient corals formed under the sea.{/cps}"
    ...
    a "{cps=35}This example is entirely made of carbonate mud.{/cps}"
...
#Metamorphic Rocks
    ...
    a "{cps=35}It looks kind of like the siltstone we saw earlier but if you looked closely in the light it is shinier than the siltstone.{/cps}"
    ...
    menu:
        "It's activity time!  Do you have an adult to help you?  And do you have flour, salt, lemon juice, food colouring and vegetable oil?\n
        If so, you can choose to do the activity now.  If not come back later."
...
label meta_layers:
    ...
    a "{cps=35}Your metamorphic layers can be layered and folded.  What happened to the layers?  Do you still have your original colours or have new colours formed?{/cps}"
...
label rockcycle:
    ...
    show we:
        ...
        xalign 0.5
        yalign 0
    a "{cps=35}Over time, weathering and erosion breaks down the rocks into smaller pieces.{/cps}"
    ...
    a "{cps=35}Cement is like gluing sediments to stick them together, which forms sedimentary rocks.{/cps}"
...
label question_2_answer:
    ...
    a "{cps=35}Great job! Igneous rocks form from magma that has cooled down and turned into a solid which is a process called crystallization.{/cps}"
...
label question_3_answer:
    ...
    a "{cps=35}That is right! Carbonate sedimentary rocks are formed from fossilized bodies of sea creatures found under water.{/cps}"
...
label inside_earth:
    ...
    a "{cps=35}Now that we have covered some geology basics, how do we study and work with geology in the real world?{/cps}"
    a "{cps=35}Geologists are interested in the data that rocks provide.{/cps}"
    ...
    a "{cps=35}Some methods that geologists use to collect data are drilling, observing outcrops and mapping.{/cps}"
...
label drilling:
    ...
    a "{cps=35}Geologists can drill into the earth to collect rock samples from the subsurface that they can observe and analyze.{/cps}"
    ...
    a "{cps=35}To drill into the earth we use equipment called a drilling rig.{/cps}"
    ...
    a "{cps=35}We can also take rock samples.  These are extracted to the surface within a protective case that can be removed later.{/cps}"
    ...
    a "{cps=35}With the drilling rigs we have today, we can't drill very far into the earth. The deepest well is a little over 12 kilometers deep.{/cps}"
    a "{cps=35}Geologists have not yet drilled as deep as the mantle.{/cps}"
...
label outcrop:
    ...
    a "{cps=35}Geologists go to the field to observe, measure and collect data from these outcrops.{/cps}"
    ...
    a "{cps=35}By writing notes down geologists can remember what they saw.{/cps}"
...
label mapping:
    ...
    a "{cps=35}Geologists will take all the data they get from drilling, core and outcrops and put it on a map.{/cps}"
...
label scale:
    ...
    a "{cps=35}It's important to mention that geologists can look at rocks at different scales.{/cps}"
    a "{cps=35}What does this mean?{/cps}"
    a "{cps=35}Geologists can tell different things about rocks depending how closely they look at them.{/cps}"
    ...
    a "{cps=35}That way you can get a better understanding of the world around you.{/cps}"
...
label ending:
    ...
    a "{cps=35}From looking the bigger picture like the planet Earth itself, to the smallest scale using microscopes,{/cps}"
...
################################################################################
    ...
    c "We wanted to give teachers, parents and students a way to explore geoscience together from home\n
     We are open to feedback and suggestions.  You can reach us at amethystgeoadventure@gmail.com"
    c "Credits:\n
    Producers: Kristyll Avila, Tanya Yeomans\n
