...
# title card
    ...
    menu:
        ...
        "{color=#bfc920}I want to follow the lesson!{/color}":
            jump lesson
...
# what is a geologists/geoscientists? What do they study?
    ...
    a "{cps=35}and those who study geology are known as {b}geologists{/b} or geoscientists.{/cps}"
...
# layers of the earth
    ...
    show tle 3:
        ...
        xalign 0.5
        yalign 0
    a "{cps=35}Like the shell in an egg, the {b}crust{/b} is the outermost and thinnest layer of the Earth that we live on.{/cps}"
    ...
    show tle 4:
        ...
        xalign 0.5
        yalign 0
    a "{cps=35}The white portion represents the {b}mantle{/b}.{/cps}"
    a "{cps=35}The mantle underneath the crust consists of melted rocks and is the source of {i}magma{/i}{/cps}"
    ...
    show tle 5:
        ...
        xalign 0.5
        yalign 0
    a "{cps=35}And the yolk is the {b}core{/b} of the Earth.{/cps}"
...
#Igneous Rocks
    ...
    scene bg plain
    show magma at truecenter with dissolve:
        size(711, 400)
    show ame_blink at left

    a "{cps=35}We call everything below the ground surface of the earth the subsurface.  {/cps}"
    a "{cps=35}This is because {i}sub{/i} means under or below in Latin, so subsurface is everything below the surface{/cps}"
    a "{cps=35}{b}Igneous rocks{/b} are formed by {u}heating existing rocks deep in the subsurface{/u}{/cps}"
    a "{cps=35}Eventually these rocks get so hot they melt and become a liquid we call {i}magma{/i}{/cps}"
    ...
    a "{cps=35}We call it an {i}intrusive igneous rock{/i}{/cps}"
    ...
    a "{cps=35}This is an example of an {i}extrusive igneous rock{/i}{/cps}"
...
label crystal_activity:
    ...
    show ame_blink at left
    show crystal_activity at truecenter behind ame_blink with dissolve
...
#Sedimentary Rocks
    ...
    a "{cps=35}Our next type of rock is {b}sedimentary rocks{/b}. This looks like a good place to start.{/cps}"
    a "{cps=35}There are three main types of sedimentary rocks.  Clastics, carbonates and evaporites.{/cps}"
    a "{cps=35}We'll talk about {i}clastic sedimentary rocks{/i} first.{/cps}"
    a "{cps=35}Clastics are formed by the {u}erosion of existing rocks into smaller pieces{/u}{/cps}"
    ...
    show river at truecenter with dissolve
...
label sed_layers:
    ...
    show seds_activity at truecenter with dissolve
...
label carbonates:
    scene bg plain
    show reef at truecenter with dissolve
    show ame_teach at left
    a "{cps=35}Another type of sedimentary rocks we call {i}carbonate rocks{/i}{/cps}"
    a "{cps=35}These sedimentary rocks are {u}formed under water{/u}.  A coral reef is a good place to form carbonate rocks.{/cps}"
    ...
    a "{cps=35}The last type of sedimentary rocks are called {i}evaporites{/i}{/cps}"
    a "{cps=35}These sedimentary rocks are {u}formed when water evaporates from a body of water{/u}{/cps}"
...
#Metamorphic Rocks
    ...
    scene bg plain
    show ame_blink at left
    show meta_env at truecenter with dissolve
    a "{cps=35}Let's move on to the last type of rock, the {b}metamorphic rocks{/b}!{/cps}"
    a "{cps=35}Metamorphic rocks are made when an existing rock is put under {u}heat and pressure{/u}.{/cps}"
...
label meta_layers:
    ...
    show meta_activity at truecenter with dissolve
    show ame_blink at left with dissolve
...
label rockcycle:
    ...
    a "{cps=35}These steps are called the {b}rock cycle{/b}.{/cps}"
    a "{cps=35}The rock cycle is {u}a process of recycling{/u} of old rocks and turning them into new rocks.{/cps}”
    ...
    show melt:
        ...
        xalign 0.5
        yalign 0
    a "{cps=35}{i}Melting{/i} occurs with hot temperatures, which turn solids into liquids.{/cps}"
    ...
    show xtal:
        ...
        xalign 0.5
        yalign 0
    a "{cps=35}This magma then cools and {i}crystallizes{/i} with colder temperatures, which turn liquids into solids.{/cps}"
    ...
    show we:
        ...
        xalign 0.5
        yalign 0
    a "{cps=35}Overtime, {i}weathering and erosion{/i} breaks down the rocks into smaller pieces.{/cps}"
    ...
    show cc:
        ...
        xalign 0.5
        yalign 0
    a "{cps=35}These sediments get transported, {i}compacted and cemented{/i}{/cps}"
    ...
    show hp:
        ...
        xalign 0.5
        yalign 0
    a "{cps=35}We also know that as we go deeper into Earth's core the {i}hotter{/i} the rocks get.{/cps}"
    a "{cps=35}Also the deeper it gets the more {i}pressure{/i} is applied on the rock due to overlying mass of the rocks above it.{/cps}"
...
label question_1:
    ...
    a "{cps=35}Which of the following is {b}not{/b} a type of rock? (Click on the answer){/cps}"
    a "Which of the following is {b}not{/b} a type of rock? (Click on the answer)"
    a "Which of the following is {b}not{/b} a type of rock? (Click on the answer)"
    a "Which of the following is {b}not{/b} a type of rock? (Click on the answer)"
...
label question_2:
    ...
    a "{cps=35}What type of rock is {u}formed by cooling down magma{/u}?{/cps}"
    a "What type or rock is {u}formed by cooling down magma{/u}?"
    a "What type or rock is {u}formed by cooling down magma{/u}?"
    a "What type or rock is {u}formed by cooling down magma{/u}?"
...
label question_3:
    ...
    a "{cps=35}Fill in the blank: The {i}carbonate sedimentary rock{/i} forms under _________.{/cps}"
    a "Fill in the blank: The {i}carbonate sedimentary rock{/i} forms under _________."
    a "Fill in the blank: The {i}carbonate sedimentary rock{/i} forms under _________."
    a "Fill in the blank: The {i}carbonate sedimentary rock{/i} forms under _________."
...
label question_5:
    ...
    a "{cps=35}Which type of rock is {u}formed by heat and pressure{/u}?{/cps}"
    a "Which type of rock is {u}formed by heat and pressure{/u}?"
    a "Which type of rock is {u}formed by heat and pressure{/u}?"
    a "Which type of rock is {u}formed by heat and pressure{/u}?"
...
label drilling:
    ...
    a "{cps=35}By {b}drilling{/b}, geologists are able to collect rock samples from the subsurface that they can observe and analyze.{/cps}"
    ...
    a "{cps=35}To drill into the earth we equipment such as a {i}drilling rig{/i}{/cps}"
    ...
    a "{cps=35}We call these rock samples {i}cores{/i}.  Cores provide physical evidence of what is going on in the subsurface.{/cps}"
...
label outcrop:
    ...
    a "{cps=35}Another method geologists can collect data is by observing {b}outcrops{/b}. Outcrops are defined as exposed bodies of rocks.{/cps}"
    a "{cps=35}Geologists go out on the field to {u}observe{/u}, {u}measure{/u} and {u}collect data{/u} from these outcrops outcrop.{/cps}"
...
label mapping:
    ...
    a "{cps=35}Geologists will take all the data they get from drilling, core and outcrops and put them on a {b}map{/b}.{/cps}"
...
label scale:
    ...
    a "{cps=35}Geologists look at rocks at {b}different scales{/b}{/cps}"
    ...
    show ame_blink at left with dissolve
    show mountains_from_air at center
